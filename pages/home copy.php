        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php if (!Session::isLoggedIn()) :   ?>
                        ...
                        <a class="text-gray-700" href="auth/login.php">
                            Log In
                        </a>
                        <a class="bg-blue-500 text-white py-2 px-4 rounded-full" href="auth/register.php">
                            Sign Up
                        </a>
                    </div>
                ...
                <?php if (Session::isLoggedIn() && Session::hasRole('student')) : echo "je suis etudeinar"?>
                    ...
                    <div class="flex items-center">
                        <img
                               src="<?= isset($userAvatar) ? $userAvatar : 'uploads/avatar0.jpg' ?>"
                            alt="Profil"
                            class="w-10 h-10 rounded-full mr-3">
                        <div class="flex flex-col">
                            <span class="text-sm font-medium text-gray-700"><?=$userName?></span>
                            <span class="text-xs text-gray-500">Apprenant</span>
                        </div>
                    </div>
                <?php endif; ?>

                <?php if (Session::isLoggedIn() && Session::hasRole('teacher')) : ?>
                    ...
                    <div class="flex items-center">
                        <img
                            src='src="<?= isset($userAvatar) ? $userAvatar : 'uploads/avatar0.jpg' ?>'
                            alt="Profil"
                            class="w-10 h-10 rounded-full mr-3">
                        <div class="flex flex-col">
                            <span class="text-sm font-medium text-gray-700"><?=$userName?></span>
                            <span class="text-xs text-gray-500">Enseignant</span>
                        </div>
